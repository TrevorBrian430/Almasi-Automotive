...
import { Shield, Truck, HeartHandshake, CheckCircle } from "lucide-react";

const iconMap: any = { Shield, Truck, HeartHandshake, CheckCircle };
...
export default function ServicePillars({ services }: { services: any[] }) {
